    ...
    <div class="col-lg-12">
        ...
        <div class="form-group form-group-checkbox row">
            <div class="col-12 text-left p-t-5">
                ...
                <label for="copy_estimate_terms"><?php echo e(cleanLang(__('lang.copy_estimate_terms'))); ?></label>
            </div>
        </div>
        ...
        <div class="form-group form-group-checkbox row">
            <div class="col-12 text-left p-t-5">
                <input type="checkbox" id="copy_estimate_notes" name="copy_estimate_notes"
                    class="filled-in chk-col-light-blue" checked>
                <label for="copy_estimate_notes"><?php echo e(cleanLang(__('lang.copy_estimate_notes'))); ?></label>
            </div>
        </div>
        ...
        <div class="form-group form-group-checkbox row">
            <div class="col-12 text-left p-t-5">
                ...
                <label for="delete_original_estimate"><?php echo e(cleanLang(__('lang.delete_original_estimate'))); ?></label>
            </div>
        </div>

    </div>
</div><?php /**PATH /home/u361343093/domains/acadifysolution.com/public_html/crm/application/resources/views/pages/estimates/components/modals/convert-to-invoice.blade.php ENDPATH**/ ?>