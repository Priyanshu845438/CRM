...
<div class="col-md-12  col-lg-5 align-self-center text-right p-b-9  <?php echo e($page['list_page_actions_size'] ?? ''); ?> <?php echo e($page['list_page_container_class'] ?? ''); ?>"
    ...
    <div id="list-page-actions">
        ...
        <span class="dropdown">
            <button type="button" data-toggle="dropdown" title="<?php echo e(cleanLang(__('lang.publish_estimate'))); ?>"
                ...
                <div class="form-group form-group-checkbox row m-b-0">
                    <div class="col-12">
                        <input type="checkbox" id="publishing_option_now" name="publishing_option_now"
                            ...
                            <?php echo e(runtimePreChecked2($bill->bill_publishing_type, 'instant')); ?>>
                    ...
                    <div class="form-group form-group-checkbox row  m-b-0">
                        <div class="col-12">
                            <input type="checkbox" id="publishing_option_later" name="publishing_option_later"
                                class="filled-in chk-col-light-blue publishing_option"
                                data-url="<?php echo e(urlResource('/estimates/'.$bill->bill_estimateid.'/publish/scheduled')); ?>"
                    ...
                    <div class="form-group row m-b-10">
                        <div class="col-sm-12">
                            <input type="text" class="form-control form-control-sm pickadate publishing_option_date"
                                ...
                                value="<?php echo e(runtimeDatepickerDate($bill->bill_publishing_scheduled_date ?? '')); ?>"
                                <?php echo e(runtimePublihItemDate($bill->bill_publishing_type)); ?>>
...
</div><?php /**PATH /home/u361343093/domains/acadifysolution.com/public_html/crm/application/resources/views/pages/bill/components/misc/estimate/actions.blade.php ENDPATH**/ ?>