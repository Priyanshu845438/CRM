...
<button type="submit" id="createCustomerButton" class="btn btn-rounded-x btn-danger waves-effect text-left"
    ...
    data-ajax-type="post" data-type="form" data-form-id="convertLeadForm"><?php echo e(cleanLang(__('lang.submit'))); ?></button><?php /**PATH /home/u361343093/domains/acadifysolution.com/public_html/crm/application/resources/views/pages/lead/components/footer.blade.php ENDPATH**/ ?>